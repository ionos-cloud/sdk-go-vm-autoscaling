...
type NicFirewallRule struct {
	...
	// Sets the initial range of the allowed port (from 1 to 65534) if the protocol TCP or UDP is selected. The value 'null' for 'portRangeStart' and 'portRangeEnd' allows all ports.
	PortRangeStart *int32 `json:"portRangeStart,omitempty"`
	// Sets the end range of the allowed port (from 1 to 65534) if the protocol TCP or UDP is selected. The value 'null' for 'portRangeStart' and 'portRangeEnd' allows all ports.
